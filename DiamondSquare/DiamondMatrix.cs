...
namespace DiamondSquare
{
    ...
    {
        public DiamondMatrix(int size, double roughness, DiamondSeeder seeder)
        {
        ...
        internal int[,] ToDiscreteMatrix(int MaxHeight, 
                                         int offsetX, int offsetZ, int Size)
        {
            int[,] ris = new int[Size, Size];
            float step = 1 / MaxHeight;
